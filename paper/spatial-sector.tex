...
\graphicspath{{../results/graphics-20221227/}, {../workflows/pypsa-eur-sec/results/}}
...
% You may include up to four highlights.%
% The length of each highlight cannot exceed 85 characters (including spaces).
...
% The eTOC blurb is a short summary that describes the context and significance
% of the findings for the broader readership. Please see the "in brief" links in
% the table of contents for examples. The blurb should be 80 words or less.
