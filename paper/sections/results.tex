...
inland in Central Europe (see \nameref{sec:es}), where the lack of a strong grid
...
\todo[inline]{ We have all 4 scenarios in graphic but don't discuss differences
    can say "roughly same, but differences explained by Sabatier SMR for
    transport, reelectrification of H2 in fuel cells" there's a paragraph later
    that we could move up here }
...
\nameref{sec:es}). However, regulatory changes would be needed in order to
