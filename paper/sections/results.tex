...
\begin{figure}
    ...
    \makebox[\textwidth][c]{
        ...
        the shares of the various technologies for each region. The colors are
        the same as in Figure 1. The line widths depict the level of added grid
        capacity, distinguishing between HVAC lines (red) and HVDC links
        (green). The added capacity of a connection between two regions was
        capped at 10 GW.}
    \label{fig:tsc}
\end{figure}
