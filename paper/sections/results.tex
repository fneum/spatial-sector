...
\begin{figure}
    ...
    \makebox[\textwidth][c]{
        ...
        \end{subfigure}
    } \caption{ \textbf{Total energy balances for scenarios with and without electricity
    or hydrogen network expansion for the 181 model regions.} Graphics reveal regions
