\subsection{Grid reinforcement restriction}

Figure \ref{fig:lv} shows the composition of total yearly system costs
...
As the grid is expanded in Figure \ref{fig:lv}, total costs decrease
...
Figure \ref{fig:map} shows the spatial distribution of the investments
...
particularly offshore wind, see Figure \ref{fig:h2}. A new network
...
\subsection{Onshore wind restriction}
...
per year (see Figure \ref{fig:onw}). The model substitutes onshore wind for
...
Net benefit is much higher: 21-48 billion per year (2.7-4.8\%)
