...
and is archived Zenodo: \href{https://doi.org/TBD}{doi:TBD}.
...
and archived Zenodo: \href{https://doi.org/TBD}{doi:TBD}.
...
\cref{fig:multisector} gives an overview of the supply, transmission,
...
For the technology and cost assumptions, we take estimates for the year
...
The full transmission network for European electricity transport is
