...
non-ferrous metals \citeS{IDEES}.
...
database \citeS{IDEES} is supplemented with additional datasets: Eurostat
energy balances \citeS{eurostatEnergyBalances2021}, USGS \citeS{unitedstatesgeologicalsurveyAmmoniaProduction2021} for ammonia production, DECHEMA
\citeS{introzziDECHEMAGesellschaft} for methanol and chlorine, and national
statistics from Switzerland \citeS{bundesamtfurenergieEnergieverbrauchIndustrie2021}.
...
The basic chemicals consumption data from the JRC IDEES \citeS{IDEES} database
...
Survey (USGS) for every country \citeS{unitedstatesgeologicalsurveyAmmoniaProduction2021}. Ammonia can be made from hydrogen and
...
0.9372 MWh$_{\ce{H2}}$/t of chlorine in the chloralkali process. The production of
...
synthetic or fossil-origin naphtha (14 MWh$_{\text{naphtha}}$/t of HVC, similar to
...
temperature above \SI{500}{\celsius} (4.1 MWh$_{\ce{CH4}}$/t of HVC)
...
mechanically recycled requiring 0.547 MWh$_{\text{el}}$/t of HVC
\citeS{meysCircularEconomy2020}, 15\% of plastics are chemically recycled
requiring 6.9 MWh$_{\text{el}}$/t of HVC based on pyrolysis and electric steam cracking
...
\citeS{dea2019}. Whether emissions are captured is decided by the model taking
...
taken from the JRC IDEES database \citeS{IDEES}. Missing countries are filled with
eurostat data \citeS{eurostatEnergyBalances2021}. Agricultural energy demands
are split into electricity (lighting, ventilation, specific electricity uses,
electric pumping devices), heat (specific heat uses, low enthalpy heat)
machinery oil (motor drives, farming machine drives, diesel-fueled pumping
devices). Heat demand is assigned at “services rural heat” buses. Time series
for demands are assumed to be constant and distributed inside countries by
population.
