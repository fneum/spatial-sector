...
estimated based on data from the JRC-IDEES database\citeS{europeancommission.jointresearchcentre.JRCIDEESIntegrated2017} and the fuel
...
country-level material production in 2015,\citeS{europeancommission.jointresearchcentre.JRCIDEESIntegrated2017} assuming constant
material demand. Missing or too coarsely aggregated data in the JRC-IDEES
database\citeS{europeancommission.jointresearchcentre.JRCIDEESIntegrated2017} is supplemented with additional datasets: Eurostat energy
...
methanol and chlorine,\citeS{bazzanella2017} and national
...
considered in our scenarios.\citeS{neuwirthFuturePotential2022} For Europe, Rehfeldt et al.
