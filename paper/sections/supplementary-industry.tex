...
chemicals like ammonia (\ce{NH3}), ethylene (\ce{C2H4}) and methanol
(\ce{CH3OH}). Energy-related emissions can be curbed by using low-emission
...
energy-balances \citeS{}, USGS \citeS{usgs} for ammonia production, DECHEMA
...
Where process heat is required our approach depends on the temperature required
