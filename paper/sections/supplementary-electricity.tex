...
data from the industrial database developed within the Hotmaps project \citeS{piamanztobiasfleiterGeoreferencedIndustrial2018}.
...
using a modified version of the GridKit \citeS{gridkit} tool. As displayed in
...
inferred from standard types for each voltage level from \citeS{oedingElektrischeKraftwerke2011}. For each HVAC
