...
\citeS{hofmannAtliteLightweight2021} and shown in \cref{fig:eligibility}.
...
\citeS{mckennaHighresolutionLargescale2022,Ryberg2018,bodisHighresolutionGeospatial2019}
...
based on \citeS{henningComprehensiveModel2014a}. The creation of heat pump time
series follows regression analyses that map soil or air temperatures to the
coefficient of performance (COP) \citeS{nouvelEuropeanMapping2015,
staffellReviewDomestic2012}. Hydroelectric inflow time series are derived from
run-off data from ERA5 and scaled using EIA annual hydropower generation
statistics \citeS{u.s.energyinformationadministrationHydroelectricityNet2022}. The open-source library \textit{atlite} \citeS{hofmannAtliteLightweight2021} provides
...
\crefrange{fig:cfs-ts}{fig:cfs-maps}.
