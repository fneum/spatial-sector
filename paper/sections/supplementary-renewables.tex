...
\textit{atlite} tool \citeS{hofmannAtliteLightweight2021} and shown in
...
CORINE  land use database \citeS{europeanenvironmentagencyeeaCorineLand} (100m
resolution)  and is further restricted by distance criteria and the natural
protection areas specified in the Natura
2000 dataset \citeS{europeanenvironmentagencyeeaNatura2000}. These criteria are
...
bathymetry dataset \citeS{gebcoGEBCO2014}. This currently disreagards the
...
and a clear-sky model based on \citeS{henningComprehensiveModel2014}. The
