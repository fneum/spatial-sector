...
\citeS{Naegler2015,Rehfeldt2018}. Processes that require temperatures below
...
- needs 1.7 MWh H2 / t steel \citeS{vogl2018} and 0.322 MWh elec / t steel \url{https://ssabwebsitecdn.azureedge.net/-/media/hybrit/files/hybrit_brochure.pdf}
...
from carbon added to get steel alloy  \citeS{vogl2018}
...
Why not add CCS to existing plants? Hard for some reason \citeS{kuramochi2012}.
...
chemicals industry consumes lots of fossil-fuel based feedstocks \citeS{Levi_2018}
...
fraction of platics \citeS{circular_economy}
...
hydrogen can be combined with Nitrogen to obtain ammonia in the Haber-Bosch process \citeS{Levi_2018}
\begin{equation}
    \ce{N2 + 3H2 -> 2NH3}
\end{equation}
...
\citeS{lechtenbohmer2016} has 14.8 MWh FT-naphtha per ton of HVC, and 2.7 MWh per
...
- FEC in steam processing is converted to methane since requires temperature above 500 \deg{} C \citeS{Rehfeldt2018}
...
involves process emissions of 0.54 t \ce{CO2} / t cement
\begin{equation}
    \ce{CaCO3 -> CaO + CO2}
\end{equation}
...
\citeS{kuramochi2012}: The major difference between centralized power plants and
...
\citeS{lechtenbohmer2016} has electrification of cement with 0.9~MWh\el/tCLinker
...
- electric annealing
- electricity demand 2.07 MWh/t of glass \citeS{lechtenbohmer2016}


\citeS{lechtenbohmer2016} also has big efficiency improvement with 0.85~MWh\el/tGlass.
...
about sustainability \citeS{BENTSEN20171211}.
...
PyPSA-Eur-Sec. Zappa et al (2019) \citeS{zappa2019} uses the same JRC database
...
\citeS{kuramochi2012} 5.2: Can integrate low-grade steam from power plants with
...
low-grade heat (need ~110 C). \citeS{kuramochi2012}

Need around 3.9 GJ/tCO2 heat for regeneration of aqueous MEA ~ 1 MWh/tCO2
\citeS{zhang2016}. Solid biomass has 0.3 tCO2/MWh\th => need 0.3 MWh heat for
