...
For the technological assumptions, we take estimates for the year 2030
(\cref{tab:si:costs}). Many of those come from a database published
by the Danish Energy Agency (DEA).\citeS{DEA} We take 2030 technology
assumptions to account for expected technology cost reductions and because the
pathway to climate neutrality implies that much of the infrastructure must be
built well in advance of 2050. Assumptions are maintained at
\href{https://github.com/pypsa/technology-data}{github.com/pypsa/technology-data}
and were taken from version 0.3.0.
