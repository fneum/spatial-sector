...
\euro47~billion per year corresponding to an expansion of XX TWkm. However, over
half of the benefit (\euro26~billion per year) is available already at a 25\%
expansion corresponding to an expansion of XX TWkm.
...
the transmission grid yields a benefit of \euro47~billion per year, removing it
incurs a cost of \euro~XX~billion per year. The lack of electricity grid is
mostly compensated by more solar PV generation, battery storage and
...
corresponding to about \SI{00}{\giga\watt} for Germany. For this investigation,
...
an additional \euro~XX~billion per year (X\%). Just as in the case of restricted
line volumes, \cref{fig:onw-restriction} reveals a nonlinear rise in system
costs: if we constrain the model to 25\% of the onshore potential (around XX~GW
for Germany), costs rise by only \euro~XX~billion per year (X\%). Thereby, 25\%
of the onshore wind potential may represent a social compromise between total
system cost, and social concerns about onshore wind development.
...
expansion from 25\% to none incurs another rise in system cost of
\euro~XX~billion per year (X\%).
