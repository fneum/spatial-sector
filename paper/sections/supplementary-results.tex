...
\begin{figure}
    ...
    \caption{Sankey diagrams of energy flows in the European system. An interactive version of these plots can be explored at \href{https://share.streamlit.io/fneum/spatial-sector-dashboard}{share.streamlit.io/fneum/spatial-sector-dashboard}.}
    \label{fig:si:sankey}
\end{figure}
...
\begin{figure}
    ...
    \begin{subfigure}{0.65\textwidth}
        \centering
        \caption{With power grid expansion, with hydrogen network}
        \includegraphics[trim=0cm 0cm 0cm 4cm, clip, width=\textwidth]{carbon-sankey-wAC-wH2.png}
    \end{subfigure}
    \begin{subfigure}{0.65\textwidth}
        \centering
        \caption{With power grid expansion, without hydrogen network}
        \includegraphics[trim=0cm 0cm 0cm 4cm, clip, width=\textwidth]{carbon-sankey-wAC-woH2.png}
    \end{subfigure}
    }
    \makebox[\textwidth][c]{
    \begin{subfigure}{0.65\textwidth}
        ...
        \vspace{1cm}
        \caption{Without power grid expansion, with hydrogen network}
        \includegraphics[trim=0cm 0cm 0cm 4cm, clip, width=\textwidth]{carbon-sankey-woAC-wH2.png}
    \end{subfigure}
    \begin{subfigure}{0.65\textwidth}
        \centering
        \vspace{1cm}
        \caption{Without power grid expansion, without hydrogen network}
        \includegraphics[trim=0cm 0cm 0cm 4cm, clip, width=\textwidth]{carbon-sankey-woAC-woH2.png}
    \end{subfigure}
    }
    \caption{Sankey diagrams of carbon flows in the European system. An interactive version of these plots can be explored at \href{https://share.streamlit.io/fneum/spatial-sector-dashboard}{share.streamlit.io/fneum/spatial-sector-dashboard}.}
...
\begin{figure}
    ...
    \begin{subfigure}{0.66\textwidth}
        ...
        \includegraphics[width=\textwidth]{20211218-181-h2/elec_s_181_lvopt__Co2L0-3H-T-H-B-I-A-solar+p3-linemaxext10_2030/capacities-built-Fischer-Tropsch.pdf}
    \end{subfigure}
