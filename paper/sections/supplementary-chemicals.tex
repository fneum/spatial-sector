...
cost \citeS{dea2019} and higher cumulative installed capacity \citeS{staffellRoleHydrogen2019a} than polymer
...
report \citeS{gasforclimateEuropeanHydrogen2020}. When the gas network is not resolved, this
...
\citeS{gemwikiLNGTerminals2021}. Biogas can be upgraded to methane (see \cref{sec:si:bio:potentials}).
...
ENTSOG maps \citeS{entsogTransmissionCapacity2021} and other publicly available data sources. It includes data
...
following conversion factors derived from
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        \centering
        \caption{potentials not included}
        \includegraphics[width=\textwidth]{biomass-not included.pdf}
    \end{subfigure}
    }
    \caption{Regional distribution of biomass potentials seperated by solid biomass, biogas and potentials not included. Only residual biomass feedstocks are included. Potentials are based on the medium availability scenario for 2030 from the JRC ENSPRESO database.}
